			...
			<div class="concent">
						...
						<div class="bundle  bundle-last ">
							...
							<div class="bundle-main">
								...
								<ul class="item-content clearfix">
									...
									<li class="td td-sum">
										<div class="td-inner">
											<em tabindex="0" id="price_${product.id}" class="J_ItemSum number">${product.price*productNums[status.index]}</em>
										</div>
									</li>
									<li class="td td-op">
										<div class="td-inner">
				...
				<div class="float-bar-wrapper">
					...
					<div class="float-bar-right">
						...
						<div class="btn-area">
<%-- 							<a href="${pageContext.request.contextPath}/order／${cookie.user_id.value}/pay" onclick="gen_order()" id="J_Go" class="submit-btn submit-btn-disabled" aria-label="请注意如果没有选择宝贝，将无法结算"> --%>
							<a href="#" onclick="gen_order()" id="J_Go" class="submit-btn submit-btn-disabled" aria-label="请注意如果没有选择宝贝，将无法结算">
								<span>结&nbsp;算</span></a>
						</div>
					</div>
				...
				function gen_order(){
					...
					$('input:checkbox:checked').each(function (index, item) {
						...
						price = "price_" + $(this).val();
						var test1 = document.getElementById(quantity).value;
						//alert("gen_order2="+test1);
						//var test2 = document.getElementById(price).innerText;
						//alert("price="+price);
						//alert("gen_order2="+test2);
						product_ids = product_ids + $(this).val() + ",";
						//alert("product_ids="+product_ids);
						quantity_nums = quantity_nums + test1 + ",";
						//alert("quantity_nums="+quantity_nums);
						//sum_price = sum_price + test2;
						//alert("sum_price2="+test2);
					});
					//alert("${pageContext.request.contextPath}/order/${cookie.user_id.value}/pay?product_ids="
					//		+ product_ids + "&quantity_nums=" + quantity_nums);
					window.location.href="${pageContext.request.contextPath}/order/${cookie.user_id.value}/pay?product_ids="
							+ product_ids + "&quantity_nums=" + quantity_nums;
				}
